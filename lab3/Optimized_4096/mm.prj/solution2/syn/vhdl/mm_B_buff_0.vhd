...
architecture rtl of mm_B_buff_0_ram is 
...
architecture arch of mm_B_buff_0 is
    component mm_B_buff_0_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mm_B_buff_0_ram_U :  component mm_B_buff_0_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
