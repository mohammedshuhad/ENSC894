...
set C_modelArgList {
	{ C int 32 regular {array 1048576 { 2 3 } 1 1 }  }
	{ A int 32 regular {array 1048576 { 1 3 } 1 1 }  }
	{ B int 32 regular {array 1048576 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ C_address0 sc_out sc_lv 20 signal 0 } 
	...
	{ A_address0 sc_out sc_lv 20 signal 1 } 
	{ A_ce0 sc_out sc_logic 1 signal 1 } 
	{ A_q0 sc_in sc_lv 32 signal 1 } 
	{ B_address0 sc_out sc_lv 20 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "11836339201", "EstimateLatencyMax" : "11836339201",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11836339201", "Max" : "11836339201"}
	, {"Name" : "Interval", "Min" : "-1048562686", "Max" : "-1048562686"}
]}
...
set Spec2ImplPortList { 
	C { ap_memory {  { C_address0 mem_address 1 20 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 32 }  { C_q0 mem_dout 0 32 } } }
