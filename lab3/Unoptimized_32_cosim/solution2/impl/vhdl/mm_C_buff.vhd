...
architecture rtl of mm_C_buff_ram is 
...
architecture arch of mm_C_buff is
    component mm_C_buff_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mm_C_buff_ram_U :  component mm_C_buff_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
