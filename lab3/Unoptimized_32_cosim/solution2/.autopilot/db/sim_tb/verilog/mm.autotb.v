...
`define AUTOTB_TVIN_C  "./c.mm.autotvin_C.dat"
`define AUTOTB_TVIN_A  "./c.mm.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.mm.autotvin_B.dat"
`define AUTOTB_TVIN_alpha  "./c.mm.autotvin_alpha.dat"
`define AUTOTB_TVIN_beta  "./c.mm.autotvin_beta.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.mm.autotvin_C.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.mm.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.mm.autotvin_B.dat"
`define AUTOTB_TVIN_alpha_out_wrapc  "./rtl.mm.autotvin_alpha.dat"
`define AUTOTB_TVIN_beta_out_wrapc  "./rtl.mm.autotvin_beta.dat"
`define AUTOTB_TVOUT_C  "./c.mm.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.mm.autotvout_C.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 26849;
...
assign arrayC_we1[0] = C_we1;
assign arrayC_we1[1] = C_we1;
assign arrayC_we1[2] = C_we1;
assign arrayC_we1[3] = C_we1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mm.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.mm.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mm.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mm.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.mm.autotvout_C.dat with impl_rtl.mm.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
